...
from .views import submit_assignment_page, list_submissions_page, grade_submission_page, my_submissions_page
...
urlpatterns = [
    ...
    path('my/submissions/', my_submissions_page, name='my-submissions-page'),  # NEW
]
